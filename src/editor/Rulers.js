...
class Rulers {
  ...
  */
  manageScroll () {
    console.log("John manageScroll () Enetered!!!!")
    ...
    console.log(this.rulerX.scrollLeft)
    console.log(this.rulerY.scrollTop)
  }
  ...
  updateRulers (scanvas, zoom) {
    console.log("John updateRulers (scanvas, zoom) Entered!!!!")
    ...
    for (d = 0; d < 2; d++) {
      ...
      console.log("rulerLen is: " + rulerLen)
      ...
      for (i = 0; i < this.rulerIntervals.length; i++) {
       ...
       console.log("this.rulerIntervals.length is :" + this.rulerIntervals.length)
