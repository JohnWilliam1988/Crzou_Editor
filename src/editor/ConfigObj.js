  ...
  constructor (editor) {
    ...
    */
    ...
    /**
      ...
      * @property {Float} [canvas_expansion=1] The minimum area visible outside the canvas, as a multiple of the image dimensions. The larger the number, the more one can scroll outside the canvas.
